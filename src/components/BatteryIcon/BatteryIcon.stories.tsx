...
storiesOf('Components|BatteryIcon', module)
  ...
  .add('Dark variant charging 20%', () => <BatteryIcon level={20} charging variant="dark" />)
  .add('Dark variant charging 10%', () => <BatteryIcon level={10} charging variant="dark" />)
  .add('Dark variant charging 0%', () => <BatteryIcon level={0} charging variant="dark" />)
  .add('Dark variant 100%', () => <BatteryIcon level={100} variant="dark" />)
  .add('Dark variatn 20%', () => <BatteryIcon level={20} variant="dark" />)
  .add('Dark variant 10%', () => <BatteryIcon level={10} variant="dark" />)
